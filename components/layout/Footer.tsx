      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div className="col-span-1 md:col-span-1">
          <Image
            ...
            height={106}
            loading="lazy"
            className="mb-6 brightness-0 invert h-12 w-auto object-contain no-radius"
          />
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3 text-sm text-gray-300">
              ...
              <div className="flex flex-col gap-1">
                <a href={`tel:${SITE_INFO.phoneClean}`} className="hover:text-roray-greenlight transition-colors">{SITE_INFO.phone}</a>
                <a href={`tel:${SITE_INFO.phoneSecondaryClean}`} className="hover:text-roray-greenlight transition-colors">{SITE_INFO.phoneSecondary}</a>
              </div>
            </li>
            <li className="flex items-start gap-3 text-sm text-gray-300">
              ...
              <a href={`mailto:${SITE_INFO.email}`} className="hover:text-roray-greenlight transition-colors">{SITE_INFO.email}</a>
            </li>
          </ul>
        </div>
      </div>
