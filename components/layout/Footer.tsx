      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 bg-white/10 flex items-center justify-center hover:bg-roray-green transition-colors">
        ...
        <div>
          <h4 className="font-display font-bold text-lg mb-6 tracking-wide">Services</h4>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/about" className="text-gray-300 hover:text-roray-greenlight transition-colors text-sm">About Us</Link></li>
            <li><Link href="/team" className="text-gray-300 hover:text-roray-greenlight transition-colors text-sm">Our Team</Link></li>
            <li><Link href="/contact" className="text-gray-300 hover:text-roray-greenlight transition-colors text-sm">Contact Us</Link></li>
            <li><Link href="/book" className="text-gray-300 hover:text-roray-greenlight transition-colors text-sm text-roray-greenlight font-semibold">Book Consultation</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="font-display font-bold text-lg mb-6 tracking-wide">Contact</h4>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
          ...
          <div className="flex gap-6">
            <span>{SITE_INFO.footerCredit} <a href={SITE_INFO.footerCreditLink} className="text-white hover:text-roray-green transition-colors" target="_blank" rel="noopener noreferrer">NEXTEC CORP</a></span>
          </div>
        </div>
      </div>
    </footer>
