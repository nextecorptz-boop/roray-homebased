          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  href={`https://wa.me/${SITE_INFO.phoneClean}`}
                  variant="outline"
                  className="border-roray-green text-roray-green hover:bg-roray-green hover:text-white"
                >
                  Chat on WhatsApp
                </Button>
              </div>
            ...
            <div className="bg-bone p-8 border border-gray-200 no-radius">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold tracking-widest uppercase text-gray-500 mb-1">{t('location')}</p>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold tracking-widest uppercase text-gray-500 mb-1">{t('email')}</p>
