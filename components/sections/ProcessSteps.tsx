  ...
  return (
    <section className="bg-white section-pad">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-4 relative">
          {/* Desktop connecting line */}
          <div className="hidden lg:block absolute top-8 left-0 w-full h-px bg-gray-200 z-0"></div>
          
          {steps.map((step, idx) => (
            <div key={idx} className="relative z-10 lg:text-center pl-20 lg:pl-0">
              {/* Number Circle */}
