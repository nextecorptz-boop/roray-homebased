  ...
  return (
    <section className="bg-navy section-pad relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-15 pointer-events-none">
        <Image
          src={IMAGES.careExplanation}
          alt="Medical professional explaining care plan to patient"
          fill
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="img-frame aspect-square w-full bg-navy-deep border border-gray-800">
              <Image
                src={IMAGES.nursingCare}
                alt="Nurse taking patient blood pressure at home"
                fill
